...
#define HTML_CFG_1 "\" method=\"POST\"><div class=\"fg row\"><label for=\"dn\" class=\"cs3 cfl\">Device Name</label><div class=\"cs9\"><input type=\"text\" name=\"hostname\" required=\"\" placeholder=\"My-ESP8266 (Required)\" id=\"dn\" class=\"fc\" maxlength=\"63\" value=\""

// Close hostname value; OTA Password; open SSID
#define HTML_CFG_2 "\"></div></div><div class=\"fg row\"><label for=\"op\" class=\"cs3 cfl\">OTA Password</label><div class=\"cs9\"><input type=\"password\" name=\"otaPassword\" placeholder=\"OTA Password\" id=\"op\" class=\"fc\" maxlength=\"63\"></div></div><hr><div class=\"fg row\"><label for=\"sn\" class=\"cs3 cfl\">SSID</label><div class=\"cs9\"><input type=\"text\" name=\"ssid\" required=\"\" placeholder=\"My home Wi-Fi Network (Required)\" id=\"sn\" class=\"fc\" maxlength=\"63\" value=\""

// Close SSID; W-Fi password; open MQTT Broker Host
#define HTML_CFG_3 "\"></div></div><div class=\"fg row\"><label for=\"wp\" class=\"cs3 cfl\">Wi-Fi Password</label><div class=\"cs9\"><input type=\"password\" name=\"netPass\" placeholder=\"Wi-Fi Password\" id=\"wp\" class=\"fc\" maxlength=\"63\"></div></div><hr><div class=\"fg row\"><label for=\"mh\" class=\"cs3 cfl\">MQTT Broker Host</label><div class=\"cs9\"><input type=\"text\" name=\"mqttHost\" placeholder=\"192.168.42.13\" id=\"mh\" class=\"fc\" maxlength=\"63\" value=\""

// Close MQTT Host, open MQTT Port
#define HTML_CFG_4 "\"></div></div><div class=\"fg row\"><label for=\"mp\" class=\"cs3 cfl\">MQTT Port</label><div class=\"cs9\"><input type=\"text\" name=\"mqttPort\" placeholder=\"1883 (default)\" id=\"mp\" class=\"fc\" maxlength=\"5\" value=\""

// Close MQTT Port, open MQTT Username
#define HTML_CFG_5 "\"></div></div><div class=\"fg row\"><label for=\"mu\" class=\"cs3 cfl\">MQTT Username</label><div class=\"cs9\"><input type=\"text\" name=\"mqttUser\" placeholder=\"MQTT User\" id=\"mu\" class=\"fc\" maxlength=\"63\" value=\""

// Close MQTT Username; MQTT Password; close form
#define HTML_CFG_6 "\"></div></div><div class=\"fg row\"><label for=\"qp\" class=\"cs3 cfl\">MQTT Password</label><div class=\"cs9\"><input type=\"password\" name=\"mqttPass\" placeholder=\"MQTT password\" id=\"qp\" class=\"fc\" maxlength=\"63\"></div></div><button type=\"submit\" class=\"btn btn-pr\">Apply changes</button></form>"
